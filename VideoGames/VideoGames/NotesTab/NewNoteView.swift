...
//protocol saveButtonPressedDelegate: AnyObject {
//    func saveN
//}

final class NewNoteView: UIView, UITextViewDelegate {
...
extension NewNoteView : UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
        return GamesViewController.games?.count ?? 0
    }
